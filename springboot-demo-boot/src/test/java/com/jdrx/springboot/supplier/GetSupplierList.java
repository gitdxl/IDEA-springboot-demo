...
public class GetSupplierList {
    private static String api = "api/0/supplier/getSupplierList";

    public static void main(String[] args) {
        Logger logger = LoggerFactory.getLogger(GetSupplierList.class);
        ...
        for (int i = 0; i < 1000; i++) {
            try {
                ...
                Call<ResposeVO> call = helper.getSupplierList(token, map);
