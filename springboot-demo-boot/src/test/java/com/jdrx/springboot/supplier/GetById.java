...
public class GetById {
    private static String api = "api/0/supplier/getById";

    public static void main(String[] args) {
        Logger logger = LoggerFactory.getLogger(GetById.class);
        ...
        for (int i = 0; i < 1000; i++) {
            try {
                //
                map.put("id", new Random().nextInt(100000));//TODO

                long startTime = System.currentTimeMillis();

                Call<ResposeVO> call = helper.getById(token, map);
